...
def main():
    ...
    # results_rssv_2 = load_and_filter_data('/home/falbuquerque/Documents/projects/Project_PMP/saves/SaveCluster/24-06-24_save_cluster/Literature_test_2/outputs/solutions/2024-06-24_LIT/Results_cplex/results_all_cplex.csv', 'RSSV_EXACT_CPMP_BIN', instance_column='type_service')
    results_rssv = load_and_filter_data('/home/falbuquerque/Documents/projects/Project_PMP/saves/SaveCluster/24-06-25_save_cluster/test_h_bandwidth_smaller/outputs/solutions/2024-06-25_LIT/Results_cplex/results_all_cplex.csv', 'RSSV_EXACT_CPMP_BIN', instance_column='type_service')
    ...
    plot_results([results_stefanello15, results_cplex, results_rssv, results_rssv_2], 
                ['Stefanello15', 'CPLEX', 'RSSV_smaller_h', 'RSSV_bigger_h'], instance_column='instance')
